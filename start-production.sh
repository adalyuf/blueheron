...
celery --app=topranks worker --loglevel=info --detach --queues celery,express --concurrency=20
...
#celery --app=topranks --broker=redis://:TopRedisPass99@18.219.253.102:6379 flower --port=5555
...
#celery --app=topranks --broker=redis://:TopRedisPass99@18.219.253.102:6379 worker --loglevel=info
