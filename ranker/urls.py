...
urlpatterns = [
    ...
    path("projects/<int:project_id>/add_domain/"        , login_required(project_views.project_add_domain)              , name="project_add_domain"),
    path("projects/<int:project_id>/remove_domain/"     , login_required(project_views.project_remove_domain)           , name="project_remove_domain"),
    path("projects/<int:project_id>/add_user/"          , login_required(project_views.project_add_user)                , name="project_add_user"),
