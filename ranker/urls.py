...
urlpatterns = [
    ...
    path('conversation/add/<int:product_id>/<int:domain_id>/', views.conversation_add, name='conversation_add'),
    path('conversation/edit/<int:conversation_id>/', views.conversation_edit, name='conversation_edit'),
    path('conversation/edit/<int:conversation_id>/update_order/', views.conversation_update_order, name='conversation_update_order'),
