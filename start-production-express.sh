...
#celery --app=topranks --broker=redis://:TopRedisPass99@3.143.113.56:6379 flower --port=5555
...
#celery --app=topranks --broker=redis://:TopRedisPass99@3.143.113.56:6379 worker --loglevel=info
