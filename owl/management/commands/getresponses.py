...
from owl.models import Domain, TokenType, Token, Product, ProductTemplate, Conversation, Message
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        conversations = Conversation.objects.filter(answered_at__isnull=True)[:5]
